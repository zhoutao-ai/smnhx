...
const FEATURES = [
  ...
  },
  {
    ...
    points: [
      ...
      'ai解读命盘：针对你的命盘直接提问，「今年能换工作吗」「什么时候结婚运最好」',
    ],
  },
  {
    tag: '格局识别',
...
const PALETTES: Record<Theme, ColorPalette> = {
  dark: {
    bgBase: '#080c14',
    heroGradient: 'linear-gradient(to bottom, #080c14 0%, #080c14 6%, #0e1428 22%, #140a20 40%, #0e1428 68%, #080c14 86%, #080c14 100%)',
    navBg: '#080c14',
    navBorder: 'rgba(255,255,255,0.04)',
    goldGrad: 'linear-gradient(160deg,#a87828 0%,#d4b060 40%,#a87828 70%,#c89840 100%)',
    goldSolid: '#c89848',
    goldLine: 'rgba(200,152,72,0.4)',
    tagText: 'rgba(200,152,72,0.6)',
    textPrimary: '#e8e2d0',
    textSecond: '#c0b898',
    textMuted: '#908868',
    textFaint: 'rgba(220,210,180,0.5)',
    accent: '#c89848',
    accentSoft: 'rgba(200,152,72,0.15)',
    cardBg: 'rgba(255,255,255,0.03)',
    cardBorder: 'rgba(255,255,255,0.07)',
    cardShadow: '0 4px 32px rgba(0,0,0,0.55)',
    featureBg: 'rgba(255,255,255,0.025)',
    featureBord: 'rgba(255,255,255,0.05)',
    glowTint: 'rgba(200,152,72,0.06)',
    glowBlue: 'rgba(60,40,120,0.08)',
    glowPurple: 'rgba(80,50,140,0.06)',
    niBg: 'rgba(255,255,255,0.025)',
    niBorder: 'rgba(200,152,72,0.2)',
    niDivider: 'rgba(255,255,255,0.05)',
    niCardBg: 'rgba(255,255,255,0.025)',
    niCardBord: 'rgba(255,255,255,0.05)',
    niCardShadow: '0 2px 20px rgba(0,0,0,0.45)',
    starBg: 'rgba(255,255,255,0.025)',
    starBorder: 'rgba(200,152,72,0.2)',
    starText: 'rgba(200,152,72,0.65)',
    ctaBg: 'linear-gradient(135deg,#8a6828,#c89848,#8a6828)',
    ctaText: '#f8f4e0',
    footerText: 'rgba(255,255,255,0.05)',
    scrollLine: 'rgba(200,152,72,0.3)',
    scrollText: 'rgba(255,255,255,0.10)',
    altSection: 'rgba(255,255,255,0.012)',
    quoteBg: 'rgba(200,152,72,0.04)',
  },
  light: {
    bgBase: '#f8f3e8',
    heroGradient: 'linear-gradient(to bottom, #f8f3e8 0%, #f8f3e8 6%, #d8b898 18%, #a85838 32%, #3a1a08 50%, #3a1a08 70%, #a85838 84%, #f8f3e8 100%)',
    navBg: '#f8f3e8',
    navBorder: 'rgba(180,100,50,0.15)',
    goldGrad: 'linear-gradient(160deg,#a03028 0%,#c44536 40%,#a03028 70%,#d45040 100%)',
    goldSolid: '#c44536',
    goldLine: 'rgba(196,69,54,0.4)',
    tagText: 'rgba(180,60,48,0.65)',
    textPrimary: '#1a1810',
    textSecond: '#3a3828',
    textMuted: '#585448',
    textFaint: '#989488',
    accent: '#c44536',
    accentSoft: 'rgba(196,69,54,0.10)',
    cardBg: 'rgba(253,250,244,0.92)',
    cardBorder: 'rgba(180,100,50,0.22)',
    cardShadow: '0 4px 24px rgba(140,80,30,0.10)',
    featureBg: 'rgba(253,250,244,0.8)',
    featureBord: 'rgba(180,100,50,0.18)',
    glowTint: 'rgba(196,69,54,0.05)',
    glowBlue: 'rgba(140,60,40,0.04)',
    glowPurple: 'rgba(120,60,50,0.03)',
    niBg: 'rgba(253,250,244,0.85)',
    niBorder: 'rgba(180,100,50,0.22)',
    niDivider: 'rgba(180,100,50,0.10)',
    niCardBg: 'rgba(253,250,244,0.95)',
    niCardBord: 'rgba(180,100,50,0.18)',
    niCardShadow: '0 2px 16px rgba(140,80,30,0.08)',
    starBg: 'rgba(253,250,244,0.75)',
    starBorder: 'rgba(180,100,50,0.28)',
    starText: 'rgba(180,60,48,0.7)',
    ctaBg: 'linear-gradient(135deg,#8a2820,#c44536,#8a2820)',
    ctaText: '#fdfaf4',
    footerText: '#c0a088',
    scrollLine: 'rgba(180,100,50,0.25)',
    scrollText: '#c0a088',
    altSection: 'rgba(253,250,244,0.4)',
    quoteBg: 'rgba(253,250,244,0.95)',
  },
  frost: {
    bgBase: '#f2f6f9',
    heroGradient: 'linear-gradient(to bottom, #f2f6f9 0%, #f2f6f9 6%, #a0c0bc 18%, #3a6860 32%, #0a1a18 50%, #0a1a18 70%, #3a6860 84%, #f2f6f9 100%)',
    navBg: '#f2f6f9',
    navBorder: 'rgba(90,130,120,0.15)',
    goldGrad: 'linear-gradient(160deg,#3a7a68 0%,#5a9e8a 40%,#3a7a68 70%,#7ab8a0 100%)',
    goldSolid: '#5a9e8a',
    goldLine: 'rgba(90,158,138,0.4)',
    tagText: 'rgba(80,140,120,0.65)',
    textPrimary: '#1a2428',
    textSecond: '#3a4448',
    textMuted: '#5a6468',
    textFaint: '#8a9498',
    accent: '#5a9e8a',
    accentSoft: 'rgba(90,158,138,0.10)',
    cardBg: 'rgba(255,255,255,0.88)',
    cardBorder: 'rgba(120,160,150,0.25)',
    cardShadow: '0 4px 24px rgba(60,100,90,0.08)',
    featureBg: 'rgba(255,255,255,0.75)',
    featureBord: 'rgba(120,160,150,0.2)',
    glowTint: 'rgba(90,158,138,0.05)',
    glowBlue: 'rgba(70,130,120,0.06)',
    glowPurple: 'rgba(80,120,130,0.04)',
    niBg: 'rgba(255,255,255,0.8)',
    niBorder: 'rgba(120,160,150,0.2)',
    niDivider: 'rgba(120,160,150,0.10)',
    niCardBg: 'rgba(255,255,255,0.9)',
    niCardBord: 'rgba(120,160,150,0.16)',
    niCardShadow: '0 2px 16px rgba(60,100,90,0.06)',
    starBg: 'rgba(255,255,255,0.7)',
    starBorder: 'rgba(100,140,130,0.26)',
    starText: 'rgba(80,140,120,0.7)',
    ctaBg: 'linear-gradient(135deg,#3a7a68,#5a9e8a,#3a7a68)',
    ctaText: '#f8faf9',
    footerText: '#a0c0b8',
    scrollLine: 'rgba(90,158,138,0.3)',
    scrollText: '#a0c0b8',
  ...
  jade: {
    bgBase: '#0a1410',
    heroGradient: 'linear-gradient(to bottom, #0a1410 0%, #0a1410 6%, #0e1c18 22%, #122820 40%, #0e1c18 68%, #0a1612 86%, #0a1410 100%)',
    navBg: '#0a1410',
    navBorder: 'rgba(255,255,255,0.04)',
    goldGrad: 'linear-gradient(160deg,#3d8a6a 0%,#56b890 40%,#3d8a6a 70%,#78d8a8 100%)',
    goldSolid: '#56b890',
    goldLine: 'rgba(86,184,144,0.4)',
    tagText: 'rgba(86,184,144,0.6)',
    textPrimary: '#dcf0e4',
    textSecond: '#b0d4c0',
    textMuted: '#78b898',
    textFaint: 'rgba(200,240,220,0.5)',
    accent: '#56b890',
    accentSoft: 'rgba(86,184,144,0.15)',
    cardBg: 'rgba(255,255,255,0.03)',
    cardBorder: 'rgba(255,255,255,0.07)',
    cardShadow: '0 4px 32px rgba(0,0,0,0.55)',
    featureBg: 'rgba(255,255,255,0.025)',
    featureBord: 'rgba(255,255,255,0.05)',
    glowTint: 'rgba(86,184,144,0.05)',
    glowBlue: 'rgba(40,140,100,0.08)',
    glowPurple: 'rgba(60,120,130,0.05)',
    niBg: 'rgba(255,255,255,0.025)',
    niBorder: 'rgba(86,184,144,0.18)',
    niDivider: 'rgba(255,255,255,0.05)',
    niCardBg: 'rgba(255,255,255,0.025)',
    niCardBord: 'rgba(255,255,255,0.05)',
    niCardShadow: '0 2px 20px rgba(0,0,0,0.45)',
    starBg: 'rgba(255,255,255,0.025)',
    starBorder: 'rgba(86,184,144,0.18)',
    starText: 'rgba(86,184,144,0.65)',
    ctaBg: 'linear-gradient(135deg,#2d7a5a,#56b890,#2d7a5a)',
    ctaText: '#e8f8f0',
    footerText: 'rgba(255,255,255,0.05)',
    scrollLine: 'rgba(86,184,144,0.3)',
    scrollText: 'rgba(255,255,255,0.08)',
    altSection: 'rgba(255,255,255,0.012)',
    quoteBg: 'rgba(86,184,144,0.04)',
  },
  dusk: {
    bgBase: '#0d0f1a',
    heroGradient: 'linear-gradient(to bottom, #0d0f1a 0%, #0d0f1a 6%, #141828 22%, #1a1020 40%, #141828 68%, #0d0f1a 86%, #0d0f1a 100%)',
    navBg: '#0d0f1a',
    navBorder: 'rgba(255,255,255,0.04)',
    goldGrad: 'linear-gradient(160deg,#a07830 0%,#d4a458 40%,#a07830 70%,#c89840 100%)',
    goldSolid: '#d4a458',
    goldLine: 'rgba(212,164,88,0.4)',
    tagText: 'rgba(212,164,88,0.6)',
    textPrimary: '#e8e4f0',
    textSecond: '#c8c0d8',
    textMuted: '#8a82a0',
    textFaint: 'rgba(220,215,240,0.5)',
    accent: '#d4a458',
    accentSoft: 'rgba(212,164,88,0.15)',
    cardBg: 'rgba(255,255,255,0.03)',
    cardBorder: 'rgba(255,255,255,0.07)',
    cardShadow: '0 4px 32px rgba(0,0,0,0.55)',
    featureBg: 'rgba(255,255,255,0.025)',
    featureBord: 'rgba(255,255,255,0.05)',
    glowTint: 'rgba(212,164,88,0.06)',
    glowBlue: 'rgba(80,60,140,0.08)',
    glowPurple: 'rgba(100,60,160,0.06)',
    niBg: 'rgba(255,255,255,0.025)',
    niBorder: 'rgba(212,164,88,0.2)',
    niDivider: 'rgba(255,255,255,0.05)',
    niCardBg: 'rgba(255,255,255,0.025)',
    niCardBord: 'rgba(255,255,255,0.05)',
    niCardShadow: '0 2px 20px rgba(0,0,0,0.45)',
    starBg: 'rgba(255,255,255,0.025)',
    starBorder: 'rgba(212,164,88,0.2)',
    starText: 'rgba(212,164,88,0.65)',
    ctaBg: 'linear-gradient(135deg,#8a6828,#d4a458,#8a6828)',
    ctaText: '#f8f4e8',
    footerText: 'rgba(255,255,255,0.05)',
    scrollLine: 'rgba(212,164,88,0.3)',
    scrollText: 'rgba(255,255,255,0.08)',
    altSection: 'rgba(255,255,255,0.012)',
    quoteBg: 'rgba(212,164,88,0.04)',
  },
};
  ...
  return (
    <div style={{ background: c.bgBase, transition: 'background 0.35s ease' }} className="overflow-x-hidden">
      ...
      <section className="relative z-10 py-20 lg:py-24 px-6"
        style={{
          background: (theme === 'dark' || theme === 'jade' || theme === 'dusk')
                  ...
                  <div className="relative w-14 h-14 shrink-0 rounded-full flex items-center justify-center lg:mb-3"
                    style={{
                      background: ready
                        ...
                        : ((theme === 'dark' || theme === 'jade' || theme === 'dusk') ? 'rgba(184,146,42,0.05)' : '#fdf8ee'),
                    ...
                    <div className="flex items-baseline gap-2 lg:flex-col lg:gap-0 lg:mb-1">
                      ...
                      {s.note && (
                        <div className="text-[9px] tracking-[0.15em] px-2 py-0.5 rounded-full lg:hidden"
                          style={{
                            color: c.goldSolid,
                            background: (theme === 'dark' || theme === 'jade' || theme === 'dusk') ? 'rgba(184,146,42,0.1)' : 'rgba(184,146,42,0.08)',
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-14 py-20">
        <div className="mx-auto" style={{ maxWidth: '1280px' }}>
          <div className="rounded-2xl p-10 md:p-14 text-center"
            style={{
              background: (theme === 'dark' || theme === 'jade' || theme === 'dusk') ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.8)',
            ...
            <FadeIn>
              ...
              <div className="flex justify-center gap-3 flex-wrap mb-6">
                {['感情匹配度分析', '合伙创业评估', '亲子缘分解读', '婚前相性评估'].map(item => (
                  <span key={item} style={{
                    ...
                    background: (theme === 'dark' || theme === 'jade' || theme === 'dusk') ? 'rgba(212,168,67,0.08)' : 'rgba(212,168,67,0.12)',
                    border: `1px solid ${c.goldLine}`,
                    color: c.goldSolid,
                  }}>
                    {item}
              ...
              <motion.button
                ...
                style={{
                  background: (theme === 'dark' || theme === 'jade' || theme === 'dusk') ? 'rgba(255,255,255,0.08)' : 'rgba(140,100,20,0.1)',
                  border: `1px solid ${c.goldLine}`,
                  color: c.goldSolid,
                  cursor: 'pointer',
                }}>
