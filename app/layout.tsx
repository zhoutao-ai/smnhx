...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://topsmtao.win'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      <head>
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{var t=localStorage.getItem('ziwei-theme');if(t==='dark'||t==='light'||t==='frost'||t==='jade'||t==='dusk')document.documentElement.setAttribute('data-theme',t);else document.documentElement.setAttribute('data-theme','light');}catch(e){}})();` }} />
      </head>
